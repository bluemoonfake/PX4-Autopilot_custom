#!/usr/bin/env python3
"""
geometry_reference.py — Independently verify antenna tracker geometry.

Computes expected bearing, pitch, and distance for a tracker/target pair. Use
it as a reference alongside tracker_status; it does not verify the PX4 module
or MAVLink pipeline by itself.

Usage from the PX4-Autopilot repository root:
    # Default: target roughly 100 m north and 50 m above tracker SITL origin
    python3 Tools/antenna_tracker/geometry_reference.py
    ...
    # degE7 integers, as used by PX4 target parameters
    python3 Tools/antenna_tracker/geometry_reference.py \
